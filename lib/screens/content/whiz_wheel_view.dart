...
class WhizWheelView extends StatefulWidget {
  final String endpoint;
  const WhizWheelView({super.key, required this.endpoint});

  @override
  State<WhizWheelView> createState() => _WhizWheelViewState();
}

class _WhizWheelViewState extends State<WhizWheelView> {
  static const _lastUrlKey = 'ww.lastUrl';
  ...
  Widget build(BuildContext context) {
    if (_startUrl == null) {
      return const Scaffold(
        ...
        body: Center(child: CircularProgressIndicator(color: BezelPalette.amber)),
      );
    }
